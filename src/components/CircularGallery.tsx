...
class Media {
  ...
  onResize({ screen, viewport }: { screen?: ScreenSize; viewport?: Viewport } = {}) {
    ...
    this.plane.scale.y = this.viewport.height * 0.82;
...
class App {
  ...
  screen!: ScreenSize; viewport!: Viewport; raf = 0;
  ...
  createMedias(items: { image: string; text: string }[] | undefined, bend: number, textColor: string, borderRadius: number, font: string) {
    const defaultItems = [
      { image: 'https://picsum.photos/seed/42/800/600', text: 'Bridge' },
      { image: 'https://picsum.photos/seed/63/800/600', text: 'Desk Setup' },
      { image: 'https://picsum.photos/seed/77/800/600', text: 'Waterfall' },
      { image: 'https://picsum.photos/seed/88/800/600', text: 'Strawberries' },
      { image: 'https://picsum.photos/seed/15/800/600', text: 'Deep Diving' },
      { image: 'https://picsum.photos/seed/31/800/600', text: 'Train Track' },
    ];
...
export function CircularGallery({ items, bend = 3, textColor = '#ffffff', borderRadius = 0.05, font = 'bold 30px Figtree', fontUrl, scrollSpeed = 2, scrollEase = 0.05 }: CircularGalleryProps) {
